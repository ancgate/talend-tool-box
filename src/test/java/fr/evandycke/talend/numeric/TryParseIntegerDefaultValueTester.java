...
/**
 * TryParseIntegerDefaultValueTester représente la classe de test de conversion d'un
 * objet en type Integer.
 * 
 * @author elie.vandycke
 * 
 */
public class TryParseIntegerDefaultValueTester extends TestCase {
	...
	public class TestSet {
		 ...
		 *            Résultat attendu
		 */
		public TestSet(Object value, int expectedResult) {
	...
	/**
	 * Teste la conversion d'un objet en type Integer, avec une valeur par
	 * défaut
	 */
	@Test
	public void testConvertIntegerDefaultValue() {
		...
		for (TestSet t : list) {
			...
			int result = IntegerHelper.tryParse(t.getValue(), DEFAULT_VALUE);
