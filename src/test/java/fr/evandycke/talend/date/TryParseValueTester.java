...
/**
 * TryParseValueTester représente la classe de test de conversion d'un objet en
 * type Date.
 * 
 * @author elie.vandycke
 * 
 */
public class TryParseValueTester extends TestCase {
	...
	public void testTryParse() {
		...
		for (TestSet t : list) {
			...
			Date result = DateHelper.tryParse(t.getValue());
